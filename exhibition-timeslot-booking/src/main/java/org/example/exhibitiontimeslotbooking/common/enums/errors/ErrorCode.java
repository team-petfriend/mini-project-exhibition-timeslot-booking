...
public enum ErrorCode {
    SUCCESS(HttpStatus.OK, "5000", "성공적으로 완료되었습니다.", "success"),
    CREATED(HttpStatus.CREATED, "5001", "데이터 생성이 성공적으로 완료되었습니다.", "created success"),
    ...
    ACCESS_DENIED(HttpStatus.UNAUTHORIZED, "A003", "접근 권한이 없습니다.", "Access denied"),
